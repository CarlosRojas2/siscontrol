                                   ...
                                   <meta name="csrf-token" content="{{ csrf_token() }}">
                                        ...
                                        <div class="col-xl-7 col-lg">
                                            ...
                                            <div class="form-group">
                                                <select onchange="select_salida_produto(this)" name="salida_producto_id" id="salida_producto_id" class="form-control select-lg select2">
                                                    ...
                                                    <option value="{{$item->id}}"  data-stok="{{$item->stock}}" {{($chorisos->prod_productos_id == $item->id)? 'selected' : ' '}} >{{$item->descripcion}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row row-sm">
                                        ...
                                        <div class="col-xl-5 col-lg">
                                            ...
                                            <input id="cant_procesada" name="cant_procesada" class="text-center form-control" type="text" value="{{$chorisos->cantidad_producida}}" onkeypress="return filterFloat(event,this);">
                                        </div>
                                    </div><br>
                                    <div class="d-flex">
                                        <div class="col-xl-12">
                                                        ...
                                                        <tbody>
                                                            @foreach ($insumos as $item)
                                                                <tr>
                                                                    ...
                                                                    <td><input type="text" class="text-center cant_clas form-control" name="{{$item->nombre}}" id="{{$item->nombre}}" onkeypress="return filterFloat(event,this);"></td>
                                                                </tr>
                                                            @endforeach
                                                                <tr>
                                                                    <th class="text-center">{{$n=$n+1}}</th>
