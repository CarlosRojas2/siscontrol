									...
									<div class="row row-sm">
										<div class="card-body mt-2 mb-2">
											...
											<form method="POST" action="{{ route('login') }}">
												...
												<p class="mb-4 text-muted tx-13 ml-0 text-left">Inicie sesión para crear, descubrir y conectarse con la organización</p>
												<div class="form-group text-left">
													<label>Correo electrónico</label>
													<input class="form-control" name="email" id="email" placeholder="Email..." type="email" :value="old('email')" required="true" autofocus>
												</div>
												<div class="form-group text-left">
