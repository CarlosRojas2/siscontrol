                ...
                <div class="page-header">
                    ...
                    <div class="d-flex">
                        <div class="justify-content-center text-white">
                            <a type="button" href="{{route('cortes.index')}}" class="btn btn-primary my-2 btn-icon-text">
                            <i class="si si-layers mr-2"></i> Ver Cortes
                            </a>
                        </div>
                    </div>
                </div>
										...
										<div class="main-content-body main-content-body-contacts">
											...
											<div class="card-body p-0 border p-0 rounded-10">
												...
												<div class="profile-cover__info">
			                                        <ul class="nav">
			                                            <li><strong>{{$corte->total}}</strong>Sub Total</li>
			                                            <li><strong>{{$corte->merma}}</strong>Merma</li>
			                                            <li><strong>{{$corte->cantidad}}</strong>Total</li>
			                                        </ul>
			                                    </div>
											</div>
											<div class="main-contact-info-body">
												<h5 class="mb-3">Insumos (kg)</h5>
												<div class="col-xl-12">
